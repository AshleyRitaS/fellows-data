...
export default function({talent}) {
    ...
    return (
        <div className="talent">
            ...
            <span className="talentIcon"><Image alt={'Icon art for '+talent.name} height={100} width={100} src={talent.icon || null}/></span><span className="talentName">{talent.name}</span>
            </div>
